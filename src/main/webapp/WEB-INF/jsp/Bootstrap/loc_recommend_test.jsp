        ...
        <div class="row justify-content-md-center">
            <div class="col-md-4">
                <div class="card mb-4 shadow-sm">
                    <form action="/test/loc_detail_test" method="get" class="m-0">
                    ...
                    <div class="card-body p-2">
                        <div class="d-flex justify-content-between align-items-center p-1">
                            <a class="card-text text-dark" href="/test/loc_detail_test" id="title_1">제목1</a>
            ...
            <div class="col-md-4">
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body p-2">
                        <div class="d-flex justify-content-between align-items-center p-1">
                            <a class="card-text text-dark" href="/test/loc_detail_test" id="title_2">제목2</a>
                            <button type="button"  class="btn"><img src="/image/icon/like/love_black.png" width="30px" height="30px" alt="찜하기"></button>
                        </div>
                    </div>
                </div>
        ...
        <div class="row justify-content-md-center">
            <div class="col-md-4">
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body p-2">
                        <div class="d-flex justify-content-between align-items-center p-1">
                            <a class="card-text text-dark" href="/test/loc_detail_test" id="title_3">제목3</a>
                            <button type="button"  class="btn"><img src="/image/icon/like/love_black.png" width="30px" height="30px" alt="찜하기"></button>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body p-2">
                        <div class="d-flex justify-content-between align-items-center p-1">
                            <a class="card-text text-dark" href="/test/loc_detail_test" id="title_4">제목4</a>
                            <button type="button"  class="btn"><img src="/image/icon/like/love_black.png" width="30px" height="30px" alt="찜하기"></button>
                        </div>
                    </div>
                </div>
