				...
				<nav aria-label="Page navigation example">
					<ul class="pagination justify-content-center">
						<c:if test="${result.next eq true}">
							<li class="page-item">
								<a class="page-link"
								   href="/amdin/loc_recommend/search?keyword=${keyword}&sortOrder=${sortOrder}&tags=${tagStr}&searchType=${searchType}&page=${result.start - 1}"
								   aria-label="Previous">
						...
						<li class="page-item active">
							<a class="page-link"
							   href="/admin/loc_recommend/search?keyword=${keyword}&sortOrder=${sortOrder}&tags=${tagStr}&searchType=${searchType}&page=${result.pageList.get(j-1)}">${result.pageList.get(j-1)}</a>
							</c:when>
							<c:otherwise>
						<li class="page-item">
							<a class="page-link"
							   href="/admin/loc_recommend/search?keyword=${keyword}&sortOrder=${sortOrder}&tags=${tagStr}&searchType=${searchType}&page=${result.pageList.get(j-1)}">
						...
						<c:if test="${result.next eq true}">
							<li class="page-item">
								<a class="page-link"
								   href="/admin/loc_recommend/search?keyword=${keyword}&sortOrder=${sortOrder}&tags=${tagStr}&searchType=${searchType}&page=${result.end + 1}">
									aria-label="Previous">
