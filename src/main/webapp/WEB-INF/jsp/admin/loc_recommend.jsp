				...
				<nav aria-label="Page navigation example">
					<ul class="pagination justify-content-center">
						<c:if test="${result.next eq true}">
							<li class="page-item">
								<a class="page-link" href="/admin/loc_recommend/list?page=${result.start - 1}"
								   aria-label="Previous">
						...
						<li class="page-item active">
							<a class="page-link"
							   href="/admin/loc_recommend/list?page=${result.pageList.get(j-1)}">${result.pageList.get(j-1)}</a>
							</c:when>
							<c:otherwise>
						<li class="page-item">
							<a class="page-link"
						...
						<c:if test="${result.next eq true}">
							<li class="page-item">
								<a class="page-link" href="/admin/loc_recommend/list?page=${result.end + 1}"
								   aria-label="Previous">
