...
<sec:authorize access="isAnonymous()">
	<span>리뷰를 작성하기 전에 로그인 해주세요</span>
	<%
		if( true ) return;
	%>
</sec:authorize>
		...
		<div class="row my-3">
			...
			<div class="col">
				<table class="table" style="table-layout: fixed;">
					...
					<tr>
						<th>내용</th>
						<td colspan="6"><textarea rows="8" cols="40" id="rev_content" name="rev_content"></textarea></td>
					</tr>
					<tr>
						<th>장소추천도</th>
						<td colspan="6">
...
<script defer>
	...
	function onClickSubmit() {
		...
		opener.reviewRegisterCallBack(reviewMapParam, imgInput);
		window.close();
	}
</script>
</body>
