                ...
                <div class="user-details basic-style">
                    ...
                    <div class="input-box">
                        ...
                        <form method="post" name="form" id="form">
                            ...
                            <input type="text" placeholder="도로명 주소" id="roadFullAddr" name="roadFullAddr" disabled required>
                            <input type="text" placeholder="도로명 주소 (상세)" id="addrDetail" name="addrDetail"  disabled required>
                            <input type="hidden" name="returnUrl" id="returnUrl" value="http://localhost:8080/service/loc_registration">
                            <sec:csrfInput/>
                        </form>
                    </div>
                    <div class="input-box">
