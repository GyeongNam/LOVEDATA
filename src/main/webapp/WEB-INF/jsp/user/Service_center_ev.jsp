    ...
    <div class="container-fluid" id="display_center" style="margin-right: 30px">
            ...
            <nav class="navbar navbar-expand-sm navbar-light static-top">
                ...
                <div class="collapse navbar-collapse d-flex justify-content-end" id="bs-example-navbar-collapse-1">
                    <ul class="navbar-nav ">
                        ...
                        <button class="btn btn-primary mx-2" type="button" id="searchBtn" onclick="event_search()">Search</button>
                    </ul>
                </div>
            </nav>
        </div>
        ...
        <div class="col" id="pu_navbar">
                            ...
                            <c:choose>
                                    ...
                                    <c:forEach var="no_pages" begin="1" end="${no_page}" step="1">
                                        <div class="page-item" id="${no_pages}">
                                            <li class="page-item ${no_pages}">
                                                <a href="/ServiceCenter/Event/${no_pages}">${no_pages}</a>
                                            </li>
                                        </div>
                                    </c:forEach>
                                </c:when>
                                <c:when test="${search eq true}">
                                    <c:forEach var="no_pages" begin="1" end="${no_page}" step="1">
                                        <div class="page-item" id="${no_pages}">
                                            <li class="page-item ${no_pages}">
                                                <a href="/ServiceCenter/Event/search/${menu}/${text}/${no_pages}">${no_pages}</a>
                                            </li>
                                        </div>
                                    </c:forEach>
                                </c:when>
            ...
            <div class="d-flex justify-content-end">
                <button class="btn btn-primary m-2" onclick="location.href='/ServiceCenter/Event_Post_add'">글쓰기</button>
            </div>
            </sec:authorize>
            </sec:authorize>
        </div>
