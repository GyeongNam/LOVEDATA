...
nhn.husky.SE2M_Configuration.CustomObject = {
	...
	sHighlight 			: '<div class="_highlight" style="position:absolute;width:58px;height:16px;line-height:0;z-index:9999"><img src=' + nhn.husky.SE2M_Configuration.LinkageDomain.sCommonStatic + '"/static/image/img/pencil2.png" alt="" width="58" height="16" style="vertical-align:top"></div>',
